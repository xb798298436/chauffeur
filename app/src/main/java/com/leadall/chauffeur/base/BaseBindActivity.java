...
public abstract class BaseBindActivity extends Activity {
...
//	public Gson gson = new Gson();
	 ...
	 * @param clickListener
	 */
	public void ShowDialog(String msg, OnClickListener clickListener) {
		...
		new AlertDialog.Builder(this).setMessage(msg)
				.setNegativeButton("确定", clickListener).setCancelable(false)
				.show();
	}

	public void ShowCheck(String msg, OnClickListener clickListener) {
		new AlertDialog.Builder(this).setMessage(msg)
				.setNegativeButton("确定", clickListener).setCancelable(false)
